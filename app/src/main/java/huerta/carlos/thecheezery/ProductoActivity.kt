...
class ProductoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imagPortada: ImageView = findViewById(R.id.producto_img)

        if (intent.getStringExtra("Button").toString() == "Cold Drinks") {
            adaptador = AdaptadorProductos(this, coldDrinks)
            imagPortada.setImageResource(R.drawable.colddrinks)
        } else if (intent.getStringExtra("Button").toString() == "Hot Drinks") {
            adaptador = AdaptadorProductos(this, hotDrinks)
            imagPortada.setImageResource(R.drawable.hotdrinks)
        } else if (intent.getStringExtra("Button").toString() == "Sweets") {
            adaptador = AdaptadorProductos(this, sweets)
            imagPortada.setImageResource(R.drawable.sweets)
        } else {
            adaptador = AdaptadorProductos(this, salties)
            imagPortada.setImageResource(R.drawable.salties)
        }
